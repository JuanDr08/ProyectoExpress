...
export const Chat = ({ nombre }) => {
    ...
    const handleMessageSend = (e) => {
        ...
        if (mensaje == '') return
        setMessages([...messages, { texto: mensaje, transmitter: 'cliente' }])
