...
export function LeftMenu(){
    return(
        <div className="leftmenu flex flex-col w-[70vw] h-[100%] bg-[var(--color-2E1108)] z-20 absolute text-white p-5 gap-5 justify-around absolute left-0 top-0">
            ...
            <div className="upper flex flex-col gap-5">
                ...
                <Link to="/chat/carlos" className="flex items-center gap-2">
                    <div className="flex items-center justify-center w-14 h-14 bg-[var(--color-703A31)] text-white rounded-full shadow-md">
