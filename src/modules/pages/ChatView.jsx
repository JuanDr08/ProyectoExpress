...
export const Chat = ({ nombre }) => {
    ...
    return (
        ...
        <>
            ...
            <main className="px-[20px] py-[30px]">

                <p></p>
                <div class="sticky  bottom-0">
                    <input type="text" class="w-full pr-20 py-2 bg-703A31 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder={`Mandar mensaje a ${nombre}`}/>
