...
export function Home() {
    ...
    const handleCategoryClick = (category) => {
        ...
        // Redirigimos a la categoría correspondiente
        ...
        <main className="pt-[70px] ">
            ...
            <div className="locationzone flex items-center justify-center">
                <div className="location flex justify-evenly h-[40px] items-center mt-5 bg-[var(--color-703A31)] w-[300px] rounded-md">
                    ...
                    <span className="text-[var(--color-blanco)] opacity-50">Ubicación de entrega actual</span>
                </div>
            </div>


            <div className="categoryzone mt-5">
                <h2 className="text-xl font-bold pl-5 text-[var(--color-9D1A1A)]">Categorías</h2>
            ...
            <div className="talleres flex flex-col justify-center items-center mt-10 gap-3">
                ...
                <div className="flex gap-5 justify-center items-center">
                    ...
                    <img src="/img/cubeshome.png" className="w-[110px] h-[18px]"/>
                    <span className="text-[var(--color-9D1A1A)]">Talleres del mes</span>
                    <img src="/img/cubeshome.png" className="w-[110px] h-[18px]"/>

                </div>
                <div>
                    <p className="text-[var(--color-9D1A1A)] opacity-50">¡Aprende como hacerlos en estos talleres educativos!</p>
                </div>
            </div>
